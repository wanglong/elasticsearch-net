...
{
	[JsonObject]
	[JsonConverter(typeof(ScheduleJsonConverter<IWeeklySchedule,ITimeOfWeek>))]
	...
	internal class ScheduleJsonConverter<TSchedule, TTime> : ReadSingleOrEnumerableJsonConverter<TTime>
		where TSchedule : class, IEnumerable<TTime>
	{
		...
		public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
		{
			...
			// IMPORTANT: relies on implicit coversion from TTime[] to TSchedule
			return times;
		}
