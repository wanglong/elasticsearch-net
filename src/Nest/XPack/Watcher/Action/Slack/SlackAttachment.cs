...
namespace Nest
{
	...
	public class SlackAttachmentsDescriptor : DescriptorPromiseBase<SlackAttachmentsDescriptor, IList<SlackAttachment>>
	{
		public SlackAttachmentsDescriptor() : base(new List<SlackAttachment>())
		{
		}
