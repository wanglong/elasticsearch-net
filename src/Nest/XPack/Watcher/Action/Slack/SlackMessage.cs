...
namespace Nest
{
	...
	public interface ISlackMessage
	{
		...
		IEnumerable<SlackAttachment> Attachments { get; set; }
	...
	public class SlackMessageDescriptor : DescriptorBase<SlackMessageDescriptor, ISlackMessage>, ISlackMessage
	{
		...
		IEnumerable<SlackAttachment> ISlackMessage.Attachments { get; set; }
		...
		public SlackMessageDescriptor Attachments(Func<SlackAttachmentsDescriptor, IPromise<IList<SlackAttachment>>> selector) =>
