...
namespace Nest
{
	...
	internal partial class LowLevelDispatch
	{
		...
		internal Task<ElasticsearchResponse<T>> XpackWatcherAckWatchDispatchAsync<T>(IRequest<XpackWatcherAckWatchRequestParameters> p , CancellationToken cancellationToken) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> XpackWatcherDeactivateWatchDispatchAsync<T>(IRequest<XpackWatcherDeactivateWatchRequestParameters> p , CancellationToken cancellationToken) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> XpackWatcherDeleteWatchDispatchAsync<T>(IRequest<XpackWatcherDeleteWatchRequestParameters> p , CancellationToken cancellationToken) where T : class
		{
			switch(p.HttpMethod)
			{
				case DELETE:
		...
		internal Task<ElasticsearchResponse<T>> XpackWatcherExecuteWatchDispatchAsync<T>(IRequest<XpackWatcherExecuteWatchRequestParameters> p , PostData<object> body, CancellationToken cancellationToken) where T : class
		{
			switch(p.HttpMethod)
			{
				case PUT:
		...
		internal Task<ElasticsearchResponse<T>> XpackWatcherGetWatchDispatchAsync<T>(IRequest<XpackWatcherGetWatchRequestParameters> p , CancellationToken cancellationToken) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
		...
		internal Task<ElasticsearchResponse<T>> XpackWatcherRestartDispatchAsync<T>(IRequest<XpackWatcherRestartRequestParameters> p , CancellationToken cancellationToken) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> XpackWatcherStartDispatchAsync<T>(IRequest<XpackWatcherStartRequestParameters> p , CancellationToken cancellationToken) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
		...
		internal Task<ElasticsearchResponse<T>> XpackWatcherStatsDispatchAsync<T>(IRequest<XpackWatcherStatsRequestParameters> p , CancellationToken cancellationToken) where T : class
		{
			switch(p.HttpMethod)
			{
				case GET:
					if (AllSet(p.RouteValues.Metric)) return _lowLevel.XpackWatcherStatsAsync<T>(p.RouteValues.Metric,u => p.RequestParameters,cancellationToken);
		...
		internal Task<ElasticsearchResponse<T>> XpackWatcherStopDispatchAsync<T>(IRequest<XpackWatcherStopRequestParameters> p , CancellationToken cancellationToken) where T : class
		{
			switch(p.HttpMethod)
			{
				case POST:
